...
!function (a) {
    ...
    return function () {
            ...
            !function (b, e) {
                ...
                return function (a) {
                    ...
                    (function (a) {
                        ...
                        function h() {
                            var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, b = new u,
                                c = b.tween(a);
                        ...
                        var i = c(1), j = "undefined" != typeof window ? window : a,
                            ...
                            l = function () {
                            }, m = null, n = null, o = f({}, i), p = function (a, b, c, d, e, f, g) {
                                var h = a < f ? 0 : (a - f) / e;
                                for (var i in b) {
                                    var j = g[i], k = j.call ? j : o[j], l = c[i];
                                    b[i] = l + (d[i] - l) * k(h)
                                }
                                return b
                            }, q = function (a, b) {
                                var c = a._attachment, d = a._currentState, e = a._delay, f = a._easing,
                                    g = a._originalState, h = a._duration, i = a._step, j = a._targetState,
                                    k = a._timestamp, l = k + e + h, m = b > l ? l : b, n = h - (l - m);
                                ...
                                var b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "linear", c = {},
                                    d = e(b);
                                if ("string" === d || "function" === d) for (var f in a) c[f] = b; else for (var g in a) c[g] = b[g] || "linear";
                                return c
                            }, t = function (a) {
                                if (a === m) (m = a._next) ? m._previous = null : n = null; else if (a === n) (n = a._previous) ? n._next = null : m = null; else {
                                ...
                                var b, c, e;
                                return b = a, (c = [{
                                    key: "_applyFilter", value: function (a) {
                                    ...
                                    key: "tween", value: function () {
                                        var b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : void 0,
                                            c = this._attachment, d = this._configured;
                                    ...
                                    key: "setConfig", value: function () {
                                        var b = this,
                                            ...
                                            d = c.attachment, e = c.delay, g = void 0 === e ? 0 : e, h = c.duration,
                                            i = void 0 === h ? 500 : h, j = c.easing, k = c.from, m = c.promise,
                                            n = void 0 === m ? Promise : m, o = c.start, p = void 0 === o ? l : o,
                                            q = c.step, r = void 0 === q ? l : q, t = c.to;
                                    ...
                                    key: "stop", value: function () {
                                        var a = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                            b = this._attachment, c = this._currentState, d = this._easing,
                                            e = this._originalState, f = this._targetState;
                    ...
                    function f(a) {
                        var b = a._currentState, c = a._originalState, d = a._targetState, e = a._easing,
                            f = a._tokenData;
                    ...
                    function l(a, b, c, d, e, f) {
                        var g = 0, h = 0, i = 0, j = 0, k = 0, l = 0, m = function (a) {
                            return ((g * a + h) * a + i) * a
                        }, n = function (a) {
                            return a >= 0 ? a : 0 - a
                        };
                        return g = 1 - (i = 3 * b) - (h = 3 * (d - b) - i), j = 1 - (l = 3 * c) - (k = 3 * (e - c) - l), function (a, b) {
                    ...
                    var n, o, p = c(0), q = /(\d|-|\.)/, r = /([^\-0-9.]+)/g, s = /[0-9.-]+/g,
                        ...
                        u = /^.*\(/, v = /#([0-9]|[a-f]){3,6}/gi, w = function (a, b) {
                            ...
                            for (var c in b) {
                                var d = b[c], e = d.chunkNames, f = d.formatString, g = G(f, F(E(a, e), e));
                                a[c] = y(t, g, A)
                            }
                        }, I = function (a, b) {
                            var c = function (c) {
                        ...
                        }, L = new p.a, M = p.a.filters, N = function (a, b, c, d) {
                            var e = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 0, f = function (a) {
                                for (var b = 1; b < arguments.length; b++) {
                                    var c = null != arguments[b] ? arguments[b] : {}, d = Object.keys(c);
                                    "function" == typeof Object.getOwnPropertySymbols && (d = d.concat(Object.getOwnPropertySymbols(c).filter(function (a) {
                                        return Object.getOwnPropertyDescriptor(c, a).enumerable
                            ...
                            function a() {
                                !function (a, b) {
                                    if (!(a instanceof b)) throw new TypeError("Cannot call a class as a function")
                                }(this, a), P.set(this, {writable: !0, value: []});
                        ...
                        }(), P = new WeakMap, Q = function (a, b, c, d, e) {
        ...
        5: [function (a, b, c) {
            var d = a("shifty"), e = a("./utils"), f = d.Tweenable,
